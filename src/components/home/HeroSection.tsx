  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8 animate-fade-in-up">
            ...
            <p className="text-xl md:text-2xl text-white/90 leading-relaxed max-w-2xl">
              Unlock exponential growth with our cloud-native platforms, advanced analytics, and AI-powered solutions.{" "}
              <span className="font-semibold text-gold">97% client satisfaction</span> across industries.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <Link to="/success-stories">
                <Button size="lg" variant="outline" className="bg-white/10 hover:bg-white/20 text-white border-white/30 text-lg px-8 h-14 backdrop-blur-sm group">
                  <Play className="mr-2 group-hover:scale-110 transition-smooth" size={20} />
                  View Success Stories
                </Button>
              </Link>
              <Link to="/contact">
                <Button size="lg" variant="ghost" className="text-white hover:bg-white/10 text-lg px-8 h-14">
                  Talk to Expert
                </Button>
              </Link>
            </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 bg-background">
        <svg className="absolute bottom-0 w-full h-24 text-primary" viewBox="0 0 1440 100" preserveAspectRatio="none">
